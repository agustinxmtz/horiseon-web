...
https://agustinxmtz.github.io/horiseon-web/
...
### HTML file changes
    ...
    content section changes
        added <section> instead of just using <div> 
...
### CSS file Changes
    ...
    changed height on .hero from 800px to 100%
    removed background-image url
    changed .content to .content-box
    ...
    removed .search-engine-optimization img, .online-reputation-management img, and social-media-marketing img replaced with .content-box img
    removed .search-engine-optimization h2, .online-reputation-management h2, and social-media-marketing h2 replaced with .content-box h2
